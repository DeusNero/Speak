...
async function transcribeAudio(blob,lang){
    ...
    try{
        ...
        const prompt='Transcribe this audio exactly as spoken. Primary language: '+langHint+'. Preserve all words including filler words. Output ONLY the transcription, nothing else.';
